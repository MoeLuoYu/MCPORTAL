...
if(isset($_POST['submit'])) {
	...
	$spanjianjie=daddslashes($_POST['spjianjie']);
	...
	$sql="update `shihun_config` set `sitename` ='{$sitename}',`keywords` ='{$keywords}',`description` ='{$description}',`dh1` ='{$dh1}',`dh2` ='{$dh2}',`dh3` ='{$dh3}',`dh4` ='{$dh4}',`dh5` ='{$dh5}',`dh5dz` ='{$dh4dz}',`server` ='{$server}',`spanjianjie` ='{$spanjianjie}',`khd` ='{$khd}',`jianjie` ='{$jianjie}',`jq` ='{$jq}',`xcp` ='{$xcp}',`xcptu` ='{$xcptu}',`tesetu1` ='{$tesetu1}',`tesetu2` ='{$tesetu2}',`tesetu3` ='{$tesetu3}',`tese1` ='{$tese1}',`tese2` ='{$tese2}',`tese3` ='{$tese3}',`tesejianjie1` ='{$tesejianjie1}',`tesejianjie2` ='{$tesejianjie2}',`tesejianjie3` ='{$tesejianjie3}',`tuanduitu1` ='{$tuanduitu1}',`tuanduitu2` ='{$tuanduitu2}',`tuanduitu3` ='{$tuanduitu3}',`tuandui1` ='{$tuandui1}',`tuandui2` ='{$tuandui2}',`tuandui3` ='{$tuandui3}',`tuanduijianjie1` ='{$tuanduijianjie1}',`tuanduijianjie2` ='{$tuanduijianjie2}',`tuanduijianjie3` ='{$tuanduijianjie3}',`tp1` ='{$tp1}',`tp2` ='{$tp2}',`tp3` ='{$tp3}',`tp4` ='{$tp4}',`tp5` ='{$tp5}',`tp6` ='{$tp6}',`music` ='{$music}'";
	if(!empty($pwd))$DB->query("update `shihun_config` set `pwd` ='{$pwd}' where `id`='{$siteid}'");
...
<div class="panel-body">
  <form action="./set.php" method="post" class="form-horizontal" role="form">
	...
	<div class="form-group">
	  <label class="col-sm-2 control-label">交流群外链（网址）</label>
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-10"><input type="text" name="spjianjie" value="<?php echo $conf['spjianjie']; ?>" class="form-control" placeholder=""/></div>
	</div><br/>
	<div class="form-group">
